...
if __name__ == "__main__":
    ...
    correct_answers = assessment_evaluator.evaluate("data/transformed_answer_keys.json", "quiz 1", response) # NOTE: It's only returning only the correct answers like this temporarily
